...
#There isnt a ton to mess with here. This is what sets up each part of the resnet

def weight_variable(shape, name=None):
    initial = tf.truncated_normal(shape, stddev=0.2) # here is where you make your weight initializations
